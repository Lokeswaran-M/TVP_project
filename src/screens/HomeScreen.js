...
import { View, Text,TouchableOpacity,useWindowDimensions,Alert, ActivityIndicator,Modal, ScrollView,Image,PermissionsAndroid, Platform} from 'react-native';
          ...
          return (
            <View key={event.EventId} style={styles.meetupCard}>
              ...
              <View style={styles.buttonRow}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      if (!isConfirmed[event.EventId] && !event.Isconfirm && !isWithin12Hours) {
                        setSelectedEvent(event); // Set the selected event to pass into modal
                        setModalVisible(true); // Show modal on button press
                      }
                    }}
                ...
                {/* Add "Disabled" text if the event is within 12 hours */}
                {isWithin12Hours && (
